...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="{{url('user-login')}}"  role="button"
                            ...
                            @else
                            <li class="dropdown">
                                <a href="#" role="button">{{Auth::user()->name}} </a> </li> <li><a
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        ...
                                        <div class="widget no-box">
                                            ...
                                            <p><a href="mailto:info@domain.com" title="glorythemes">info@domain.com</a>
                                            </p>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="images/11.jpg" alt="Third slide">
      </div>
    </div>
  </div> -->
        ...
        <script src="{{asset('js/myjs1.js')}}"></script>
</body>
